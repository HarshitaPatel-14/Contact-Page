...
export default function Index() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Main Contact Section with Black Background */}
            ...
            <div className="lg:ml-12">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Textarea
                  ...
                  onChange={handleInputChange}
                  className="bg-transparent border-gray-600 text-white placeholder:text-gray-400 min-h-32 resize-none"
                  required
                />

                <Button
                  type="submit"
                  className="w-full bg-gray-800 hover:bg-teal-500 text-white h-12 transition-colors duration-300"
                >
                  Submit
                </Button>
              </form>
      ...
      {/* Footer */}
      <footer className="relative z-10 bg-gray-100 text-black py-12 mt-24">
